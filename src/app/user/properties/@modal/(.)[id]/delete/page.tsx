...
import { Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, Button, useDisclosure, RadioGroup, Radio, user } from "@nextui-org/react";
...
const DeleteModalParallelPage = ({ params }: DeleteModalParallelPageProps) => {
