...
import Attribute from '@/app/(main)/user/profile/_components/Attribute'
import SectionTitle from '@/app/(main)/user/profile/_components/SectionTitle'
import UploadAvatarButton from '@/app/(main)/user/profile/_components/UploadAvatarButton'
